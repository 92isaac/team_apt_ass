...
const NavbarSmall = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    <div
      className={`${isSidebarOpen ? 'fixed flex justify-between items-center px-4 py-2 bg-white shadow-lg w-full' : 'fixed flex justify-between items-center px-4 py-2 bg-white shadow-lg md:hidden w-full'}`}
    >
